...
<head>
    <title>Grocery Shoppy an Ecommerce | @yield('title') </title>
    <!--/tags -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- price range -->
    <link rel="{{ asset('/') }}front/stylesheet" type="text/css" href="css/jquery-ui1.css">
    <!-- fonts -->
...
<!-- //js-files -->
<script>
    function getProductInfo(giveValue) {
        //alert(giveValue);
    }
</script>
